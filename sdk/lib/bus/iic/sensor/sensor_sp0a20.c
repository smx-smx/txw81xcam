...
SENSOR_INIT_SECTION static const unsigned char SP0A20InitTable[CMOS_INIT_LEN]= 
{
    ...
    // --- DVP/YUV tail (same as working) ---
    0xFD,0x00,
    0x32,0x15, 0x34,0x76, 0x35,0x40, 0x33,0xEF, 0x5F,0x51,
    0x12,0x18,

    // --- Minimal U/V swap test on page 1, then re-assert the exact same tail ---
    0xFD,0x01, 0x5D,0x11,   // (only change vs baseline; try 0x10 ↔ 0x11)
    0xFD,0x00,
    0x32,0x15, 0x34,0x76, 0x35,0x40, 0x33,0xEF, 0x5F,0x51,
    0x12,0x18,
